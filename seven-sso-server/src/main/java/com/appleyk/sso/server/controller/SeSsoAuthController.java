...
@RestController
@RequestMapping("/auth")
public class SeSsoAuthController {

    @Autowired
    private ASeDefaultAuthManager authManager;
    ...
    public SeResult resetPwd(String userName, String password, String resetPwd, String reResetPwd) throws Exception {
    ...
    public SeResult update(@RequestBody SeAuthUser authUser) throws SeException{
        ...
        /**替换变化的部分*/
        BeanUtils.copyProperties(user, ssoInfo.getAuthUser());
        /**更新缓存*/
        authManager.sessionCache().put(authUser.getId(), ssoInfo);
        return SeResult.ok("更新成功！",user);
    }
    ...
    public SeResult getWebAppSitesConfig() throws Exception {
